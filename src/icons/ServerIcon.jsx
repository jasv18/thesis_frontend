const ServerIcon = ({ className }) => {
  return (
    <svg className={className} fill='currentColor' viewBox='0 0 20.00 20.00' xmlns='http://www.w3.org/2000/svg' stroke='#currentColor' transform='rotate(0)matrix(1, 0, 0, 1, 0, 0)' strokeWidth='0.0002'>
